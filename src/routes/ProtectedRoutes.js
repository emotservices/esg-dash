...
import GhgReport from "../pages/esg/GhgReorts";
import EnvironmentalFramework from "../pages/esg/EnvironmentFramework";
...
const protectedRoutes = [
  ...
  { path: "/", element: <EsgDashboard /> },
  { path: "/esg-dashboard", element: <EsgDashboard /> },
  { path: "/analytics", element: <Analytics /> },
  { path: "/ghg-report", element: <GhgReport /> },
  { path: "/e-report", element: <EnvironmentalFramework /> },
];
